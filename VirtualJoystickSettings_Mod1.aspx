<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VirtualJoystickSettings.aspx_Mod1.cs" Inherits="VirtualJoystickProperties" %>
    ...
    <header>
        <nav>
            <div class="nav-wrapper">
                ...
                <%--Back Button--%>
                <a href="VirtualJoystick_Mod1.aspx" class="left"><i class="mdi-hardware-keyboard-backspace"></i></a>
            </div>
        </nav>
    </header>
            ...
            <form class="col s12" runat="server">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <label for="MaxX1Val" class="active">Maximum X Velocity</label>
                        <input runat="server" value="" id="MaxX1Val" type="text" class="validate" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <label for="MaxY1Val" class="active">Maximum Y Velocity</label>
                        <input runat="server" value="" id="MaxY1Val" type="text" class="validate" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <label for="MaxZ1Val" class="active">Maximum Z Velocity</label>
                        <input runat="server" value="" id="MaxZ1Val" type="text" class="validate" />
                    </div>
                </div>
