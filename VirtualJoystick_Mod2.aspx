<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VirtualJoystick.aspx_Mod2.cs" Inherits="ext" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <header>
        <nav>
            <div class="nav-wrapper">
                ...
                <a href="VirtualJoystickSettings_Mod2.aspx" class="hide-on-large-only right"><i class="mdi-action-settings"></i></a>
                <ul class="side-nav" id="mobile-demo">
                    ...
                    <li><a href="VirtualJoystickSettings_Mod2.aspx"><i class="mdi-action-settings left"></i>Settings</a></li>
                    <li><a href="VirtualJoystick_Mod1.aspx"><i class="mdi-image-hdr-weak left"></i>Module 1 Virtual Joysticks</a></li>
                </ul>
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <ul id='ControllerDropdown' class='dropdown-content'>
                        <li><a href="VirtualJoystick_Mod1.aspx">Module 1 Virtual Joysticks</a></li>
                    </ul>
                </ul>
    ...
    <%--Initialize iframe--%>
    <div id="content">
        <iframe width="100%" height="100%" frameborder="0" src="VirtualJoystick_Mod2.html"> </iframe>
    </div>
