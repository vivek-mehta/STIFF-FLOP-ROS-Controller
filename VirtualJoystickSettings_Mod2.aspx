    ...
    <div class="container">
        <div class="row">
            ...
            <form class="col s12" runat="server">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <label for="DivisorVal_XY2" class="active">Divisor Value For X & Y</label>
                        <input runat="server" value="" id="DivisorVal_XY2" type="text" class="validate" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <label for="DivisorVal_Z2" class="active">Divisor Value For Z</label>
                        <input runat="server" value="" id="DivisorVal_Z2" type="text" class="validate" />
                    </div>
                </div>
